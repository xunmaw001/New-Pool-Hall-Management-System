  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:10px">
        <h1 class="h1" style="color:rgba(0, 150, 136, 1);fontSize:28px;">新锐台球厅管理系统注册</h1>
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://codegen.caihongy.cn/20210128/0b0856b8ee6d4d69af63291d54dbd471.jpg");
		height: 100vh;
