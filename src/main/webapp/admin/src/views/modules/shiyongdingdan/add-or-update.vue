<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="使用日期" prop="shiyongriqi">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.shiyongriqi" label="使用日期" prop="shiyongriqi">
              <el-input v-model="ruleForm.shiyongriqi" 
                placeholder="使用日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  created() {
	this.ruleForm.shiyongriqi = this.getCurDate()
