...
export default {
  ...
  created() {
	this.ruleForm.yuyueriqi = this.getCurDateTime()
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `qiuzhuoyuyue/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.qiuzhuoyuyueCrossAddOrUpdateFlag = false;
                  this.parent.search();
