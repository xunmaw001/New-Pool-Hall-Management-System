    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="球桌介绍" prop="qiuzhuojieshao">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.qiuzhuojieshao" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.qiuzhuojieshao" label="球桌介绍" prop="qiuzhuojieshao">
                    <span v-html="ruleForm.qiuzhuojieshao"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xiaoshijiage = true;
          ...
          if(o=='qiuzhuojieshao'){
            this.ruleForm.qiuzhuojieshao = obj[o];
	    this.ro.qiuzhuojieshao = true;
            continue;
          }
          if(o=='keyueshijian'){
	...
	this.ruleForm.qiuzhuojieshao = this.ruleForm.qiuzhuojieshao.replace(reg,'../../../ssms7ukv/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `taiqiuzhuo/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.taiqiuzhuoCrossAddOrUpdateFlag = false;
                  this.parent.search();
